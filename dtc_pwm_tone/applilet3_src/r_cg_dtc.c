...
void R_DTC_Create(void)
{
    ...
    dtc_controldata_0.dtccr = _00_DTC_TRANSFER_MODE_NORMAL | _00_DTC_DATA_SIZE_8BITS | _00_DTC_SOURCE_ADDR_FIXED |
    ...
    /* Set DTCD1 */
    dtc_controldata_1.dtccr = _00_DTC_TRANSFER_MODE_NORMAL | _40_DTC_DATA_SIZE_16BITS | _00_DTC_SOURCE_ADDR_FIXED |
