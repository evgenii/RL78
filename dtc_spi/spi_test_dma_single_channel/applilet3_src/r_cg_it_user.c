...
extern void CSI_Send(void);

#if(RPB_BOARD == 1)		

static volatile uint8_t tenMsec = 0;
...
__interrupt static void r_it_interrupt(void)
{
    /* Start user code. Do not edit comment generated here */
		...
		/* trigger the periodic send every 10 msec */
		CSI_Send();
		...
		if(99 == tenMsec) {
			...
			/* keep blinking in case there are no errors*/
			if(0 == error) P7_bit.no7 = ~P7_bit.no7;
