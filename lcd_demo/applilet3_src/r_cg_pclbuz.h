...
*/
/* Clock output/buzzer output controller supply (RTCEN) */
#define _00_PCLBUZ_STOP                 (0x00U) /* stops supply of input clock */
#define _80_PCLBUZ_SUPPLY               (0x80U) /* supplies input clock */
