...
#define _02BF_TMRD_TRDGRA0_VALUE                (0x02BFU)
/* TMRD register B0 (TRDGRB0) */
#define _003F_TMRD_TRDGRB0_VALUE                (0x003FU)
/* TMRD register C0 (TRDGRC0) */
#define _02FF_TMRD_TRDGRC0_VALUE                (0x02FFU)
/* TMRD register D0 (TRDGRD0) */
#define _017F_TMRD_TRDGRD0_VALUE                (0x017FU)
