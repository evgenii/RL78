...
#define _0240_DTCD0_DEST_ADDRESS            (0x0240U)
#define _02_DTCD0_TRANSFER_BYTE             (0x02U)
#define _01_DTCD0_TRANSFER_BLOCKSIZE        (0x01U)
#define _0000_DTCD1_SRC_ADDRESS             (0x0000U)
#define _0500_DTCD1_DEST_ADDRESS            (0x0500U)
#define _02_DTCD1_TRANSFER_BYTE             (0x02U)
