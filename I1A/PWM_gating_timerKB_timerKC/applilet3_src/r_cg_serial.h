...
/*
    Serial Clock Select Register m (SPS4)
*/
/* Operating mode and clear mode selection (PRS403 - PRS400) */
/* Settings for fCLK = 32MHz (using PLL) */
#define _0000_SAU_CK40_FCLK_0               (0x0000U)    /* ck40 - fCLK */
#define _0001_SAU_CK40_FCLK_1               (0x0001U)    /* ck40 - fCLK/2^1 */
#define _0002_SAU_CK40_FCLK_2               (0x0002U)    /* ck40 - fCLK/2^2 */
#define _0003_SAU_CK40_FCLK_3               (0x0003U)    /* ck40 - fCLK/2^3 */
#define _0004_SAU_CK40_FCLK_4               (0x0004U)    /* ck40 - fCLK/2^4 */
#define _0005_SAU_CK40_FCLK_5               (0x0005U)    /* ck40 - fCLK/2^5 */
#define _0006_SAU_CK40_FCLK_6               (0x0006U)    /* ck40 - fCLK/2^6 */
#define _0007_SAU_CK40_FCLK_7               (0x0007U)    /* ck40 - fCLK/2^7 */
#define _0008_SAU_CK40_FCLK_8               (0x0008U)    /* ck40 - fCLK/2^8 */
#define _0009_SAU_CK40_FCLK_9               (0x0009U)    /* ck40 - fCLK/2^9 */
#define _000A_SAU_CK40_FCLK_10              (0x000AU)    /* ck40 - fCLK/2^10 */
#define _000B_SAU_CK40_FCLK_11              (0x000BU)    /* ck40 - fCLK/2^11 */
#define _000C_SAU_CK40_FCLK_12              (0x000CU)    /* ck40 - fCLK/2^12 */
#define _000D_SAU_CK40_FCLK_13              (0x000DU)    /* ck40 - fCLK/2^13 */
#define _000E_SAU_CK40_FCLK_14              (0x000EU)    /* ck40 - fCLK/2^14 */
#define _000F_SAU_CK40_FCLK_15              (0x000FU)    /* ck40 - fCLK/2^15 */
/* Settings for fCLK = 16MHz (using PLL) */
#define _0001_SAU_CK40_FCLK_0               (0x0001U)    /* ck40 - fCLK */
#define _0002_SAU_CK40_FCLK_1               (0x0002U)    /* ck40 - fCLK/2^1 */
#define _0003_SAU_CK40_FCLK_2               (0x0003U)    /* ck40 - fCLK/2^2 */
#define _0004_SAU_CK40_FCLK_3               (0x0004U)    /* ck40 - fCLK/2^3 */
#define _0005_SAU_CK40_FCLK_4               (0x0005U)    /* ck40 - fCLK/2^4 */
#define _0006_SAU_CK40_FCLK_5               (0x0006U)    /* ck40 - fCLK/2^5 */
#define _0007_SAU_CK40_FCLK_6               (0x0007U)    /* ck40 - fCLK/2^6 */
#define _0008_SAU_CK40_FCLK_7               (0x0008U)    /* ck40 - fCLK/2^7 */
#define _0009_SAU_CK40_FCLK_8               (0x0009U)    /* ck40 - fCLK/2^8 */
#define _000A_SAU_CK40_FCLK_9               (0x000AU)    /* ck40 - fCLK/2^9 */
#define _000B_SAU_CK40_FCLK_10              (0x000BU)    /* ck40 - fCLK/2^10 */
#define _000C_SAU_CK40_FCLK_11              (0x000CU)    /* ck40 - fCLK/2^11 */
#define _000D_SAU_CK40_FCLK_12              (0x000DU)    /* ck40 - fCLK/2^12 */
#define _000E_SAU_CK40_FCLK_13              (0x000EU)    /* ck40 - fCLK/2^13 */
#define _000F_SAU_CK40_FCLK_14              (0x000FU)    /* ck40 - fCLK/2^14 */
/* Settings for fCLK (not using PLL) */
#define _0002_SAU_CK40_FCLK_0               (0x0002U)    /* ck40 - fCLK */
#define _0003_SAU_CK40_FCLK_0               (0x0003U)    /* ck40 - fCLK */
#define _0004_SAU_CK40_FCLK_1               (0x0004U)    /* ck40 - fCLK/2^1 */
#define _0005_SAU_CK40_FCLK_2               (0x0005U)    /* ck40 - fCLK/2^2 */
#define _0006_SAU_CK40_FCLK_3               (0x0006U)    /* ck40 - fCLK/2^3 */
#define _0007_SAU_CK40_FCLK_4               (0x0007U)    /* ck40 - fCLK/2^4 */
#define _0008_SAU_CK40_FCLK_5               (0x0008U)    /* ck40 - fCLK/2^5 */
#define _0009_SAU_CK40_FCLK_6               (0x0009U)    /* ck40 - fCLK/2^6 */
#define _000A_SAU_CK40_FCLK_7               (0x000AU)    /* ck40 - fCLK/2^7 */
#define _000B_SAU_CK40_FCLK_8               (0x000BU)    /* ck40 - fCLK/2^8 */
#define _000C_SAU_CK40_FCLK_9               (0x000CU)    /* ck40 - fCLK/2^9 */
#define _000D_SAU_CK40_FCLK_10              (0x000DU)    /* ck40 - fCLK/2^10 */
#define _000E_SAU_CK40_FCLK_11              (0x000EU)    /* ck40 - fCLK/2^11 */
#define _000F_SAU_CK40_FCLK_12              (0x000FU)    /* ck40 - fCLK/2^12 */
...
*/
#define    _0022_SAU_SMR4N_INITIALVALUE     (0x0022U)
...
/* Setting of data length in DALI mode (DLSmn1 - DLSmn0) */
#define _0004_SAU_LENGTH_24                 (0x0004U)    /* 24-bit data length */
#define _0005_SAU_LENGTH_17                 (0x0005U)    /* 17-bit data length */
#define _0006_SAU_LENGTH_16                 (0x0006U)    /* 16-bit data length */
...
#define _0002_SAU_PARITY_ERROR              (0x0002U)    /* a parity error occurs during UART reception or */
...
/* Clear trigger of manchester framing error of channel n (MFECTMN) */
#define    _0080_SAU_SIRMN_MFECTMN          (0x0080U)
...
#define _0000_SAU_CH1_SNOOZE_OFF            (0x0000U)    /* disable start function from STOP state of chip */
#define _0001_SAU_CH1_SNOOZE_ON             (0x0001U)    /* enable start function from STOP state of chip */
...
/*
    SAU4 Option Control Register 4 (SOC4)
*/
/* SAU4 DALI4/UART Mode Control Bit (SDS) */
#define _0000_SAU_OPR_MODE_UART             (0x0000U)    /* UART mode */
#define _0001_SAU_OPR_MODE_DALI             (0x0001U)    /* DALI4 mode */
...
#define _01_SAU_RXD4_FILTER_ON              (0x01U)    /* noise filter on */
