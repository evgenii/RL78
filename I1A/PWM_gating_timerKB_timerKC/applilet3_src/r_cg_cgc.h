...
*/
/* Status of PLL clock mode (PLLS) */
#define _00_CGC_STATUS_THROUGH      (0x00U) /* PLL output clock not supplied */
#define _08_CGC_STATUS_PLL          (0x08U) /* PLL output clock supplied */
/* Selection of PLL output clock for CPU/peripheral hardware clock fCLK (SELPLL) */
#define _00_CGC_NOSEL_PLL           (0x00U) /* does not select PLL output clock */
#define _04_CGC_SEL_PLL             (0x04U) /* selects PLL output clock */
/* PLL output division (PLLO) */
#define _00_CGC_PLL_32              (0x00U) /* clock divided by 2 */
#define _02_CGC_PLL_16              (0x02U) /* clock divided by 4 */
...
/* Selection of source clock of PLL output clock fPLL or Main system clock fMAIN (MCM0) */
...
/*
    Illegal memory access detection control register (IAWCTL0)
*/
...
/*
    Illegal memory access detection control register (IAWCTL1)
*/
/* PORT register guard (GDPORT1) */
#define _00_CGC_DPORT1_GUARD_OFF    (0x00U) /* invalid, it is possible to write PORT register */
#define _04_CGC_DPORT1_GUARD_ON     (0x04U) /* valid, it is possible to read but not write PORT register */
/* Interrupt register guard (GDINT) */
#define _00_CGC_DINT_GUARD_OFF      (0x00U) /* invalid, it is possible to write interrupt register */
#define _02_CGC_DINT_GUARD_ON       (0x02U) /* valid, it is possible to read but not write interrupt register */
/* CG register guard (GDCG1) */
#define _00_CGC_DCG1_GUARD_OFF      (0x00U) /* invalid, it is possible to write CG register */
#define _01_CGC_DCG1_GUARD_ON       (0x01U) /* valid, it is possible to read but not write CG register */

/***********************************************************************************************************************
Macro definitions
***********************************************************************************************************************/
#define CGC_PLLWAITTIME             (800U)
